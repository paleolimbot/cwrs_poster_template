...
author: "A. Student, Graham A. Gagnon^1^"
institute: "^1^Centre for Water Resources Studies, Dalhousie University"
date: "`r Sys.Date()`"
output:
...
The research team acknowledges the support from *insert industrial partner*.
